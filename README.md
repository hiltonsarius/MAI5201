...
| Timetabling | Live Lectures: Tuesday & Thursday 8:30 pm – 10:00 pm (GYD) |
...
📌 **Time Commitment**: Students should allocate approximately 8-12 hours per week aside from lectures for self-study, assignments, and project work.

📖 **Course Textbook**: Daniel Jurafsky and James H. Martin. 2025. *Speech and Language Processing: An Introduction to Natural Language Processing, Computational Linguistics, and Speech Recognition with Language Models*, 3rd edition.
...
| 2 | **Text Processing Fundamentals**<br>- Regular Expressions<br>- Tokenization<br>- Edit Distance<br>- Text Normalization<br>Slides: [Text Processing](slides/week1/text_processing.pdf) \| [Edit Distance](slides/week2/med24.pdf) | Chapter 2: Regular Expressions, Text Normalization, and Edit Distance | - [Project Guidelines Released](#course-project) |
...
📌 **DUE DATES**: All assignments are due before 11:59 PM (Guyana time) on the specified date unless otherwise stated.
